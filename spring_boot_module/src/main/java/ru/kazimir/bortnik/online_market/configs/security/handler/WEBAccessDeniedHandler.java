...
import static ru.kazimir.bortnik.online_market.constant.WebURLConstants.REDIRECT_ERROR_403;
...
public class WEBAccessDeniedHandler implements AccessDeniedHandler {
    ...
    public void handle(HttpServletRequest httpServletRequest,
        ...
        httpServletResponse.sendRedirect(httpServletRequest.getContextPath() + REDIRECT_ERROR_403);
    }
}